...
'<figcaption><b>Formal two-stratum fit of the endemicity gradient.</b> Refitting the partial-pooling community-PPV model with an outbreak-vs-surveillance term gives outbreak π = <b>0.35</b> [0.17&ndash;0.56] versus endemic-surveillance π = <b>0.06</b> [0.03&ndash;0.14] &mdash; an odds ratio of <b>8.4</b> [2.2&ndash;20.5]. The clinical case definition is ~8&times; more predictive of true typhoid during an outbreak than in routine surveillance (CrI excludes 1).</figcaption></figure>',
'<div class="note"><b>What this means.</b> No clean <em>new</em> outbreak points were recoverable (most reports lack a blood-culture-tested denominator; N&rsquo;Cho&rsquo;s usable 286/74 is a hospital subset), so the ORI input is unchanged &mdash; and the fitted outbreak π (0.35) sits inside the model&rsquo;s existing 0.23&ndash;0.65 range, <b>validating it</b>. The new surveillance data instead pins a distinct <em>endemic</em> PPV (~0.06); applying that to outbreak response would understate outbreak PPV ~5&ndash;6&times;. Model <code>community_ppv_strata.stan</code>; tables <code>community_ppv_strata.csv</code>, <code>ppv_positivity_table.csv</code>.</div></section>',
