...
'<div class="note"><b>No clean new outbreak points.</b> Most outbreak reports lack a blood-culture-<em>tested</em> denominator (they give suspected + confirmed only), are confirmed-only, or are tiny/high-income &mdash; so the community-outbreak π set is unchanged, and the <b>ORI analyses stand</b>. N&rsquo;Cho&rsquo;s usable counts (286 tested / 74) are a hospital case-management subset, not community. The endemic-surveillance stratum is real additional data but a <em>different estimand</em> (routine surveillance, not outbreaks) &mdash; available if a broader across-endemicity PPV model is wanted. Full table: <code>manuscript/data/ppv_positivity_table.csv</code>.</div></section>',
