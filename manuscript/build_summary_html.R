...
'<section><p class="kicker">Part 3</p><h2>Beyond the outbreak: long-term impact</h2>',
'<p class="lede">A reactive campaign also shields the vaccinated cohort from the region&rsquo;s <em>ongoing</em> typhoid burden while protection lasts (~7 yr for TCV): endemic background incidence <b>plus</b> recurrent future outbreaks. <code>renewal/R/longterm.R</code> integrates both hazards (in true-typhoid units, dividing confirmed incidence by Se_BC) over a waning protection window.</p>',
'<figure>', img("fig3a_longterm_vs_outbreak.png", "long-term vs outbreak"),
'<figcaption><b>Long-term impact can dwarf the index outbreak &mdash; but only where endemicity or recurrence is high.</b> 7-yr long-term averted vs one-time outbreak-averted: Vellore <b>228&times;</b> (endemic 1,977/100k), Harare <b>4.7&times;</b> (annual recurrence since 2010), Kampala 2.6&times;, Fiji 1.6&times;, but Songkhla <b>0.3&times;</b> (endemic 1.8/100k &mdash; the outbreak dominates). Background incidence + recurrence from the outbreak-paper review; VE 0.80, coverage 0.85, mean protection 15 yr.</figcaption></figure>',
'<div class="note"><b>Implication.</b> The value of reactive TCV is <em>setting-dependent</em>: in hyper-recurrent (Harare) or high-endemic (Vellore) settings the beyond-outbreak burden averted is several- to hundred-fold the index outbreak, so a single-outbreak analysis <em>understates</em> impact; in a low-endemic one-off outbreak (Songkhla) the outbreak itself is the main prize. The Harare 2019 TCV campaign (Poncin 2022) measured coverage but <em>no post-campaign incidence</em> &mdash; this projection fills that gap. Parameters: <code>longterm_sites.csv</code>; per-site incidence &amp; recurrence: <code>BACKGROUND_RECURRENCE.md</code>.</div></section>',
